...
int Disassemble8080p(unsigned char *codebuffer, int pc)
{
    ...
    case 0xd1:
        ...
        break;
    case 0xd2:
        std::cout << "JNC $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xd3:
        std::cout << "OUT #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 2;
        break;
    case 0xd4:
        std::cout << "CNC $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xd5:
        std::cout << "PUSH D";
        break;
    case 0xd6:
        std::cout << "SUI #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 2;
        break;
    case 0xd7:
        std::cout << "RST 2";
    ...
    case 0xd8:
        ...
        break;
    case 0xda:
        std::cout << "JC $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xdb:
        std::cout << "IN #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 2;
        break;
    case 0xdc:
        std::cout << "CC $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xde:
        std::cout << "SBI #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 2;
        break;
    case 0xdf:
        std::cout << "RST 3";
    ...
    case 0xf1:
        ...
        break;
    case 0xf2:
        std::cout << "JP $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xf3:
        std::cout << "DI";
        break;
    case 0xf4:
        std::cout << "CP $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xf5:
        std::cout << "PUSH PSW";
        break;
    case 0xf6:
        std::cout << "ORI #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        break;
    case 0xf7:
        std::cout << "RST 6";
        break;
    ...
    case 0xf9:
        ...
        break;
    case 0xfa:
        std::cout << "JM $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xfb:
        std::cout << "EI";
        break;
    case 0xfc:
        std::cout << "CM $" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 3;
        break;
    case 0xfe:
        std::cout << "CPI #$" << std::hex << std::setw(2) << std::setfill('0') << (int)code[1];
        opbytes = 2;
        break;
    case 0xff:
        std::cout << "RST 7";
